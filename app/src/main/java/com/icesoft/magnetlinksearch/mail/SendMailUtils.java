...
public class SendMailUtils {
    ...
    private static final String FROM_ADD = "magnet_search_customer_service@hotmail.com"; //发送方邮箱
    private static final String FROM_PSW = "e865a695-a35c-4616-9f1b-e6327d3d0513";//发送方邮箱授权码
    private static final String TO_ADD = "magnet_search_customer_service@hotmail.com";
    //magnet_link_search@hotmail.com
    //e58b42a5-3e7e-43f2-834b-013c85544115
    //magnet_search_customer_service@hotmail.com
